...
//    var aLTAIRAltInput = window.parent.p5frame.document.getElementById('gLTAIRAlt');
 ...
 $.ajax({
   ...
   success:  function(result) {
    var thePos = result.split(' ');
    var aLTAIRLatInput = thePos[0];
    var aLTAIRLonInput = thePos[1];
    var aLTAIRAltInput = thePos[2];
//    console.log('I am here 0, and thePos is: ');
//    console.log(result);
//    console.log(aLTAIRLatInput);
//    console.log(aLTAIRLonInput);
//    console.log(aLTAIRAltInput);




//    var aLTAIRLatInput =   '48.4593';
//    var aLTAIRLonInput = '-123.3117';
//    var aLTAIRAltInput =  '500.';
    ...
    var infoSendStr = JSON.stringify(sendInfo);

//    console.log('I am here 1, and the infoSendStr is: ');
//    console.log(infoSendStr);
...
//    console.log('I am here 2');
            if ( data.valid == "false" ) {
                ...
                // the debug window
                console.log("The server rejected the submitted form data:");
...
//                predSub();
                console.log("The server accepted the form data");
                // Update the global current_uuid variable
                current_uuid = data.uuid;
                console.log("The server gave us uuid:<br>" + current_uuid);
                console.log("Starting to poll for progress JSON");
     //           handlePred(current_uuid);
            } else {
                console.log("data.valid was not a recognised state: "
                        + data.valid);
            }
        }
    });
