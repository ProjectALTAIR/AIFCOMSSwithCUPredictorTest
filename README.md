...
After first [completely uninstalling any other version of Anaconda](https://www.anaconda.com/docs/getting-started/anaconda/uninstall) or of [Python](https://www.wikihow.com/Uninstall-Python) that you might possibly already have on your computer, please install the Python 3.12 version of [Anaconda](https://www.anaconda.com/download), using the installer that you can obtain by providing your e-mail address at [this page](https://www.anaconda.com/download). Please do absolutely **nothing** via sudo or otherwise with superuser priviliges unless you absolutely have to, i.e. if there is absolutely no other way to install or perform the given action on your machine without sudo. [Installation instructions for the Anaconda installer can be found here.](https://docs.anaconda.com/anaconda/install/)
If asked during the installation, make sure to add Anaconda3 to your PATH environment variable (even though it might say that that option is not recommended), as well as registering Anaconda3 as your default Python 3.12 (if that is asked as well).  Once you have that installed, you should then have Python 3.12 installed on your computer -- it is part of the Anaconda installation.  After you successfully install the Python 3.12 version of Anaconda on your machine, you should reboot your computer (so that Anaconda's settings to make it the default location for your Python application, etc., can take effect).<br>
...
Back in your `/<www>/` (i.e., `/var/www/` or `/var/www/html/`) directory, download the package repository at [https://github.com/ProjectALTAIR/AIFCOMSSwithCUPredictorTest](https://github.com/ProjectALTAIR/AIFCOMSSwithCUPredictorTest) so that all the project files are located at `/<www>/AIFCOMSSwithCUPredictorTest/`  (and **note that your directory should be called** `AIFCOMSSwithCUPredictorTest`, ***not*** `AIFCOMSSwithCUPredictorTest-master` -- if it is the latter, just rename it to be the former).  I ***very strongly*** suggest ***not*** using git clone for this package repository download, but instead choosing to download the contents of the AIFCOMSSwithCUPredictorTest repository as a .zip file, then unzipping that file and then copying the contents to a new `/<www>/AIFCOMSSwithCUPredictorTest/` directory.  The reason for this is that git clone tends to put, and fix, incorrect file permissions on several files within your AIFCOMSSwithCUPredictorTest git repository when it clones them over, and that tends to cause _vast_ problems later. It is not a _absolute_ requirement to not use git clone for this -- but please be very strongly forwarned that using git clone, instead of just downloading the AIFCOMSSwithCUPredictorTest repository as a zip file, is a recipe for persistent file permission problems that will likely cause you lots of trouble with this software.  So, please download a zip file of this repository instead.
...
### MacOS (tested on v. 15.0.1 "Sequoia", v. 14.3 "Sonoma", on v. 12.6 "Catalina", and on earlier MacOS versions)

After first [completely uninstalling any other version of Anaconda](https://www.anaconda.com/docs/getting-started/anaconda/uninstall) or of [Python](https://www.wikihow.com/Uninstall-Python) that you might possibly already have on your  Mac computer, please install the Python 3.12 version of [Anaconda](https://www.anaconda.com/download), using the installer that you can obtain by providing your e-mail address at [this page](https://www.anaconda.com/download). Please do absolutely **nothing** via sudo or otherwise with superuser priviliges unless you absolutely have to, i.e. if there is absolutely no other way to install or perform the given action on your machine without sudo.
If asked during the installation, make sure to add Anaconda3 to your PATH environment variable (even though it might say that that option is not recommended), as well as registering Anaconda3 as your default Python 3.12 (if that is asked as well).
...
Back in your `/<www>/` (i.e., `/Users/<your user name>/Sites/`) directory, download the package repository at
[https://github.com/ProjectALTAIR/AIFCOMSSwithCUPredictorTest](https://github.com/ProjectALTAIR/AIFCOMSSwithCUPredictorTest)
so that all the project files are located at `/<www>/AIFCOMSSwithCUPredictorTest/`  (and **note that your directory should be called** `AIFCOMSSwithCUPredictorTest`, ***not*** `AIFCOMSSwithCUPredictorTest-master` -- if it is the latter, just rename it to be the former).  I ***very strongly*** suggest ***not*** using git clone for this package repository download, but instead choosing to download the contents of the AIFCOMSSwithCUPredictorTest repository as a .zip file, then unzipping that file and then copying the contents to a new `/<www>/AIFCOMSSwithCUPredictorTest/` directory.  The reason for this is that git clone tends to put, and fix, incorrect file permissions on several files within your AIFCOMSSwithCUPredictorTest git repository when it clones them over, and that tends to cause _vast_ problems later. It is not a _absolute_ requirement to not use git clone for this -- but please be very strongly forwarned that using git clone, instead of just downloading the AIFCOMSSwithCUPredictorTest repository as a zip file, is a recipe for persistent file permission problems that will likely cause you lots of trouble with this software.  So, please download a zip file of this repository instead.
...
After first [completely uninstalling any other version of Anaconda](https://www.anaconda.com/docs/getting-started/anaconda/uninstall) or of [Python](https://www.wikihow.com/Uninstall-Python) that you might possibly already have on your Windows computer, please install the Python 3.12 version of [Anaconda](https://www.anaconda.com/download), using the installer that you can obtain by providing your e-mail address at [this page](https://www.anaconda.com/download).  
Make sure to not do anything anywhere in these instructions as a non-Adminstrator user. Please install Anaconda into a location that does not have spaces, i.e. NOT under `Program Files` -- I recommend that it be installed directly under C:\ )  [Installation instructions for the Anaconda installer can be found here.](https://docs.anaconda.com/anaconda/install/)
...
not recommended), as well as registering Anaconda3 as your default Python 3.12 (if that is asked as well).  Once you have that installed, you
should then have Python 3.12 installed on your computer -- it is part of the Anaconda installation.  After you successfully install the
Python 3.12 version of Anaconda on your machine, you should reboot your computer (so that Anaconda's settings to make it the default location
