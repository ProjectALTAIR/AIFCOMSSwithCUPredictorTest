...
this would be `/var/www/` or `/var/www/html/`; for AMPPS on Windows, this would be `C:\path\to\Ampps\www\`, i.e. the installation path of AMPPS; and for Mac OS, this would likely be `/Users/<your user name>/Sites/`) and install version 1.97 (not necessarily the most recent version, but version 1.97) of CesiumJS ([https://github.com/CesiumGS/cesium/releases/download/1.97/Cesium-1.97.zip](https://github.com/CesiumGS/cesium/releases/download/1.97/Cesium-1.97.zip), _not_ the most recent version in https://cesium.com/downloads/) to an **entirely** new subdirectory here (i.e. create a new subdirectory before installing CesiumJS v1.97 into that subdirectory) - you'll need it later. 
