...
<details>
   <summary>AMP stack installation instructions for Macs running MacOS 14.x.y (Sonoma)</summary>
Details will go here.	
</details>
<details>
   <summary>AMP stack installation instructions for Macs running MacOS 12.x.y (Monterey) and MacOS 13.x.y (Ventura)</summary>
Details will go here.	
</details>
<details>
   <summary>AMP stack installation instructions for Macs running MacOS 10.15.x (Catalina) and MacOS 11.x.y (Big Sur)</summary>
Instructions for setting up an AMP stack in Catalina, i.e. Mac OS 10.15.x, can be found (for example) [here](https://tech-cookbook.com/2019/10/07/setting-up-your-local-server-on-macos-catalina-2019-mamp/) and [here](https://medium.com/@firstsquares/macos-catalina-set-up-localhost-e4a0b5d5be33).
	Note that all versions of Mac OS X ⚠️**prior to Monterey, i.e. prior to MacOS 12.x.y** ⚠️, already come with both Apache and PHP installed (you just need to turn them on, and also to install mySQL).
</details>
<details>
...
<details>
   <summary>AMP stack installation instructions for Macs running MacOS 10.13.x (High Sierra) and earlier</summary>
