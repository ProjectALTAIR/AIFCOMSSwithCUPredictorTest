...
<details>
   <summary>AMP stack installation instructions for Mac Apple (i.e. rather than Intel) CPU machines (i.e. M1, M2, M3, etc)</summary>
Details will go here.
</details>
<details>
   <summary>AMP stack installation instructions for Mac Intel CPU machines running MacOS 14.x.y (Sonoma)</summary>
Details will go here.	
</details>
<details>
   <summary>AMP stack installation instructions for Mac Intel CPU machines running MacOS 12.x.y (Monterey)</summary>
Details will go here.	
</details>
<details>
   <summary>AMP stack installation instructions for Mac Intel CPU machines running MacOS 10.15.x (Catalina)</summary>
Details will go here.	
</details>
